        ...
        case "member" : {
                $response = '<div id="shortcodes_' . $name . '_form">
						 	<table id="cocobasic_shortcode_' . $name . '">							
								...
								<tr>
									<th><label for="shortcode_' . $name . '_name">' . esc_html__('Member Name', 'cocobasic-shortcode') . '</label></th>
									<td><input style="width:150px" name="' . $name . '" id="shortcode_' . $name . '_name" /><br /><small>' . esc_html__('set member name', 'cocobasic-shortcode') . '</small></td>
								</tr>
                                                                
                                                                <tr>
									<th><label for="shortcode_' . $name . '_position">' . esc_html__('Member Position', 'cocobasic-shortcode') . '</label></th>
									<td><input style="width:150px" name="' . $name . '" id="shortcode_' . $name . '_position" /><br /><small>' . esc_html__('set member position', 'cocobasic-shortcode') . '</small></td>
								</tr>
