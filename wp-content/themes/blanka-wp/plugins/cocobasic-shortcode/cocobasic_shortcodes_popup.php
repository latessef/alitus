    ...
    <body>
        <div id="cocobasic_shortcodes_popup">
            <ul>  
                ...
                <li><a id="cocobasic_member" href="#"><?php echo esc_html__('Member', 'cocobasic-shortcode'); ?></a></li>                                
                ...
                <li><a id="cocobasic_big_number" href="#"><?php echo esc_html__('Big Number', 'cocobasic-shortcode'); ?></a></li>                                
                ...
                <li class="shortcode_divider_line">     </li>	                
                <li><a id="cocobasic_curve_text" href="#"><?php echo esc_html__('Curve (Home) Text', 'cocobasic-shortcode'); ?></a></li>
                <li><a id="cocobasic_intro_desc" href="#"><?php echo esc_html__('Home Description', 'cocobasic-shortcode'); ?></a></li>
                <li><a id="cocobasic_big_text" href="#"><?php echo esc_html__('Big Text', 'cocobasic-shortcode'); ?></a></li>
                <li><a id="cocobasic_med_text" href="#"><?php echo esc_html__('Medium Text', 'cocobasic-shortcode'); ?></a></li>                
                <li class="shortcode_divider_line">     </li>	                                	  	  	
                <li><a id="cocobasic_latest_posts" href="#"><?php echo esc_html__('Latest Posts (News)', 'cocobasic-shortcode'); ?></a></li>   
                <li><a id="cocobasic_social" href="#"><?php echo esc_html__('Social Holder', 'cocobasic-shortcode'); ?></a></li>   
                <li><a id="cocobasic_social_icons" href="#"><?php echo esc_html__('Social Icons', 'cocobasic-shortcode'); ?></a></li>                   
                <li><a id="cocobasic_contact_info" href="#"><?php echo esc_html__('Contact Info', 'cocobasic-shortcode'); ?></a></li>                                   
